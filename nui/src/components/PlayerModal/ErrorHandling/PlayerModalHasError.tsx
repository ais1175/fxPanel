...
export const PlayerModalHasError: React.FC<PlayerModalHasErrorProps> = ({ msg }) => {
    const t = useTranslate();

    return (
        <BoxRoot flexGrow={1} mt={-2} display="flex" flexDirection="column" alignItems="center" justifyContent="center">
            <Box display="flex">
