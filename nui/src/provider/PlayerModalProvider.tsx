import React, { useContext, createContext, useCallback, useEffect, ReactNode } from 'react';
...
export const PlayerModalProvider: React.FC<PlayerModalProviderProps> = ({ children }) => {
