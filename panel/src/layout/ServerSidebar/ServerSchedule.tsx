        ...
        <>
            <p>
                ...
                <ul className="ml-4 list-disc">
                    <li>
                        <InlineCode>+MM</InlineCode> relative time in minutes (example: <InlineCode>+15</InlineCode> for
                        15 minutes from now.)
                    </li>
                    <li>
                        <InlineCode>HH:MM</InlineCode> absolute 24-hour time (example: <InlineCode>23:30</InlineCode>{' '}
                        for 11:30 PM.)
                    </li>
                </ul>
            </p>
            ...
            <div className="mt-2 flex flex-row flex-wrap justify-between gap-2">
                {hasScheduledRestart ? (
                    <Button
                        size="xs"
                        variant="ghost"
                        className="bg-muted grow border shadow-sm"
                ...
                {showEnableBtn && (
                    <Button
                        size="xs"
                        variant="ghost"
                        className="bg-muted grow border"
