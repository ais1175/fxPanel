    ...
    return (
        <SettingsCardShell cardCtx={cardCtx} pageCtx={pageCtx} onClickSave={handleOnSave}>
            ...
            <SettingItem label="Hide Announcement Notifications">
                ...
                />
                <SettingItemDesc>
                    Suppresses the display of announcements, allowing you to implement your own announcement via the
                    event <InlineCode>txAdmin:events:announcement</InlineCode>.
            ...
            <SettingItem label="Hide Direct Message Notification">
                ...
                />
                <SettingItemDesc>
                    Suppresses the display of direct messages, allowing you to implement your own direct message
                    notification via the event <InlineCode>txAdmin:events:playerDirectMessage</InlineCode>.
            ...
            <SettingItem label="Hide Warning Notification">
                ...
                />
                <SettingItemDesc>
                    Suppresses the display of warnings, allowing you to implement your own warning via the event{' '}
            ...
            <SettingItem label="Hide Scheduled Restart Warnings">
                ...
                />
                <SettingItemDesc>
                    Suppresses the display of scheduled restart warnings, allowing you to implement your own warning via
                    the event <InlineCode>txAdmin:events:scheduledRestart</InlineCode>.
