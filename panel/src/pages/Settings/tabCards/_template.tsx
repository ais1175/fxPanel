...
export default function SettingsCardTemplate({ cardCtx, pageCtx }: SettingsCardProps) {
    ...
    return (
        ...
        >
            <h2 className="text-warning-inline text-2xl">Simple Examples</h2>
            ...
            <SettingItem label="Switch">
                ...
                />
                <SettingItemDesc>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</SettingItemDesc>
            </SettingItem>
            ...
            <h2 className="text-warning-inline text-2xl">Compex Examples (data marshalling)</h2>
            ...
            {showAdvanced && <h2 className="text-warning-inline text-2xl">Advanced Examples (custom components)</h2>}
            ...
            <SettingItem label="Big Radio" showIf={showAdvanced}>
                <RadioGroup
                    ...
                    disabled={pageCtx.isReadOnly}
                >
                    <BigRadioItem groupValue={states.bigRadio} value="disabled" title="Disabled" desc="desc as text" />
                    <BigRadioItem
