...
export const processPerfLog = (perfLog: SvRtLogFilteredType, perfProcessor: PerfProcessorType) => {
    ...
    let currentLifespan: PerfLifeSpanType = structuredClone(emptyPerfLifeSpan);
    ...
    return dataStart && dataEnd && lifespans.length ? { dataStart, dataEnd, lifespans } : undefined;
};
 ...
 */
export const getServerStatsData = (lifespans: PerfLifeSpanType[], windowHours: number, apiDataAge: number) => {
