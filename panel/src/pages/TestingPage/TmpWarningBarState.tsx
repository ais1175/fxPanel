...
export default function TmpWarningBarState() {
    const { offlineWarning, setOfflineWarning, txUpdateData, setTxUpdateData, fxUpdateData, setFxUpdateData } =
        useWarningBar();
        ...
        <Card className="w-min">
            ...
            <CardContent className="space-y-4">
                <div className="space-y-2 rounded border p-2">
                    <pre className="bg-muted p-2">{JSON.stringify(offlineWarning, null, 2)}</pre>
                ...
                <div className="space-y-2 rounded border p-2">
                    <pre className="bg-muted p-2">{JSON.stringify(txUpdateData, null, 2)}</pre>
                    <div className="flex justify-start gap-3 border-t pt-2">
                        <Button
                            size="sm"
                            onClick={() =>
                ...
                <div className="space-y-2 rounded border p-2">
                    <pre className="bg-muted p-2">{JSON.stringify(fxUpdateData, null, 2)}</pre>
                    <div className="flex justify-start gap-3 border-t pt-2">
                        <Button
                            size="sm"
                            onClick={() =>
