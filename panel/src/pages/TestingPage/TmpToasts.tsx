    ...
    return (
        <>
            <div className="group mx-auto mt-auto flex gap-4">
                ...
                <Button size={'lg'} variant="default" onClick={openDefault}>
                    Default
                </Button>
                <Button size={'lg'} variant="default" onClick={openMarkdownColors}>
                    Markdown
                </Button>
                <Button size={'lg'} variant="default" onClick={openSpecial}>
                    Special
                </Button>
                <Button size={'lg'} variant="default" onClick={openUpdatable}>
                    Updatable
                </Button>
                <Button size={'lg'} variant="default" onClick={openApiResp}>
                    API Resp
                </Button>
                <Button size={'lg'} variant="default" onClick={testPendingBug}>
                    <p>
                        Pending Bug <br />
