                ...
                <form onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-6 items-center gap-4">
                            ...
                            <div className="col-span-full space-y-1 sm:col-span-5">
                                <Select onValueChange={setSelectedDuration} defaultValue={selectedDuration}>
                                ...
                                <div className="flex flex-row gap-2">
                                    <Input
                                        ...
                                        required
                                    />
                                    <Select onValueChange={setCustomUnits} defaultValue={customUnits}>
                                        <SelectTrigger
                                            id="durationUnits"
