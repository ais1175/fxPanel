 ...
 */
export const processDropsSummary = (
    apiData: PlayerDropsSummaryHour[],
    ...
    const expectedCategoriesSorted = Object.entries(expectedCategoriesDropsTotal).sort((a, b) => b[1] - a[1]);
    const expectedCategoriesOrder = Object.fromEntries(expectedCategoriesSorted.map(([cat, _], index) => [cat, index]));
    const unexpectedCategoriesSorted = Object.entries(unexpectedCategoriesDropsTotal).sort((a, b) => b[1] - a[1]);
