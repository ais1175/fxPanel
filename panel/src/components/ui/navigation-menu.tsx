...
const navigationMenuTriggerStyle = cva(
    ...
    'group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors focus:text-secondary-foreground focus:outline-hidden disabled:pointer-events-none disabled:opacity-50 data-active:bg-secondary/50 data-[state=open]:bg-secondary/50',
);
