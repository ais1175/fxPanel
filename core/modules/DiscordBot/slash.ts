...
const statusCommand: ApplicationCommandDataResolvable = {
    ...
    options: [
        ...
        },
        {
            type: ApplicationCommandOptionType.Subcommand,
            name: 'remove',
            description: 'Removes the configured persistent fxPanel status embed.',
        },
    ],
};
...
const infoCommand: ApplicationCommandDataResolvable = {
    type: ApplicationCommandType.ChatInput,
    name: 'info',
    description: 'Searches for a player in the fxPanel Database and prints information.',
    options: [
        {
            type: ApplicationCommandOptionType.Subcommand,
            name: 'self',
...
const adminInfoCommand: ApplicationCommandDataResolvable = {
    type: ApplicationCommandType.ChatInput,
    name: 'admininfo',
    description: 'Admin-only: searches for a player and shows identifiers, notes and action history.',
    options: [
        {
            type: ApplicationCommandOptionType.Subcommand,
            name: 'self',
 ...
 * Exported commands
 */
export default [statusCommand, whitelistCommand, infoCommand, adminInfoCommand] as ApplicationCommandDataResolvable[];
