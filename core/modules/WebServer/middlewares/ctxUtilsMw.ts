...
export type CtxTxUtils = {
    ...
    getBody: <T>(schema: ZodType<T>, errorMessage?: string | false) => T | undefined;
    getParams: <T>(schema: ZodType<T>, errorMessage?: string | false) => T | undefined;
    getQuery: <T>(schema: ZodType<T>, errorMessage?: string | false) => T | undefined;
    utils: {
