...
suite('parseSchedule', () => {
    ...
    it('should let the average american type 24:00', () => {
        ...
        expect(result.valid).toEqual([{ string: '00:00', hours: 0, minutes: 0 }]);
        expect(result.invalid).toEqual([]);
    });
    ...
    it('should handle invalid stuff', () => {
        ...
        expect(result.valid).toEqual([{ string: '12:34', hours: 12, minutes: 34 }]);
...
suite('redactStartupSecrets', () => {
    ...
    it('should handle multiple redactions in a single array', () => {
        ...
        const args = ['sv_licenseKey', 'cfxk_12345_abcdef', 'someOtherArg', 'value', 'steam_webApiKey', validSteamKey];
        const expected = [
            'sv_licenseKey',
            '[REDACTED cfxk...abcdef]',
            'someOtherArg',
            'value',
            'steam_webApiKey',
            redactedString,
    ...
    it('should handle a real example', () => {
        const args = [
            ...
            '+set',
            'sv_licenseKey',
            'cfxk_xxxxxxxxxxxxxxxxxxxx_yyyyy',
            '+set',
            'onesync',
            'enabled',
            '+set',
    ...
    it('should redact discord webhooks', () => {
        ...
        const expected = ['aaa', 'https://discord.com/api/webhooks/[REDACTED]/[REDACTED]', 'bbb'];
        expect(misc.redactStartupSecrets(args)).toEqual(expected);
    });
});
