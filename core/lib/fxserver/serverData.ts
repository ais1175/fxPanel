 ...
 */
export const getServerDataConfigs = async (
    serverDataPath: string,
    serverDataContent: ServerDataContentType,
): Promise<ServerDataConfigsType> => {
    ...
    for (const [entryPath, entrySize] of serverDataContent) {
        ...
        try {
            ...
            configs.push([entryPath, emsg(error)]);
        }
    }
...
export const findPotentialServerDataPaths = async (initialPath: string) => {
    ...
    try {
        ...
        /* sibling directory lookup failed */
    }
