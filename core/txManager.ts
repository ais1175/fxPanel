...
import TxRuntimeMetrics from '@modules/Metrics/txRuntime';
...
export default class TxManager {
    public deployer: Deployer | null = null;
    ...
    startDeployer(
        ...
        this.deployer = new Deployer(recipeText, deploymentID, targetPath, isTrustedSource, {
            ...customMetaData,
